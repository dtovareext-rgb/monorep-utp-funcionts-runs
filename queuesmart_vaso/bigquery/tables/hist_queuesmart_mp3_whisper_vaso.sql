...
--
-- Lectura de audios/tickets: queuesmart_mp3_enriched_vaso / hist_queesmart_mp3_catalog_vaso
-- Escritura: solo estas tablas vaso.
--
--   bq query --use_legacy_sql=false --location=US \
--     --project_id=prd-utpbi-data-operation \
--     < queuesmart_vaso/bigquery/tables/hist_queuesmart_mp3_whisper_vaso.sql
-- Canonical copy also in cr_serialize_queuesmart/bigquery/tables/
-- =============================================================================

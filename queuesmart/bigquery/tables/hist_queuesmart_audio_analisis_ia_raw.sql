...
CREATE OR REPLACE TABLE `prd-utpbi-data-operation.adf_speech_analytics.hist_queuesmart_audio_analisis_ia_process_data_raw` (
  -- Identidad / contexto ticket
  process_date DATE,
  gcs_uri STRING,
  file_name STRING,
  ...
  -- Secuencia (enteros como STRING por flexibilidad del modelo)
  t_saludo STRING,
